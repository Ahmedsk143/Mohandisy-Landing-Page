...
export class OurServicesComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.services = [
      ...
      {
        heading: 'الخدمات الهندسية',
        para: 'تشمل هذه الخدمة على الهندسة المعمارية ،هندسة الكهرباء ، هندسة الميكانيكا ، والتصميم الداخلي والخارجي ايضاَ.',
        img: '"../../../../assets/Rectangle 179.png',
      },
      {
        heading: 'خدمات المقاولات',
        para: 'تشمل خدمة المقاولات على أكثر من بند مثل  (البناء والسباكة والكهرباء والبلاط والتكييف والنجارة والحديد والدهان).',
        img: '"../../../../assets/Rectangle 174.png',
      },
      {
